...
# def run_classic_sequential(clients, testloader, initial_net, dataset_name, batch_size, rounds, local_epochs, num_clients, device, all_round_to_clients):
def run_classic_sequential(clients, testloader, initial_net, rounds, num_local_epoch, num_clients, device, all_round_to_clients):
