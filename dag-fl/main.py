...
if __name__ == "__main__":
    ...
    loss_list, accuracy_list = run_traditional_fl(fds, initial_net, dataset_name, batch_size, epochs, num_local_epoch, num_clients, DEVICE)
    ...
    loss_list, accuracy_list = run_classic_sequential(fds, initial_net, dataset_name, batch_size, epochs, num_local_epoch, num_clients, DEVICE, all_round_to_clients)
    write_logs(log_file,loss_list, accuracy_list, label)
    ...
    loss_list, accuracy_list = run_centralized_randomized_order(fds, initial_net, dataset_name, batch_size, epochs, num_local_epoch, num_clients, DEVICE, all_round_to_clients)
    write_logs(log_file,loss_list, accuracy_list, label)
    ...
    loss_list, accuracy_list = run_dag_fl(fds, initial_net, dataset_name, batch_size, epochs, num_local_epoch, num_clients, DEVICE, all_round_to_clients, label)
    write_logs(log_file,loss_list, accuracy_list, label)
    ...
    loss_list, accuracy_list = run_dag_rand_tips(fds, initial_net, dataset_name, batch_size, epochs, num_local_epoch, num_clients, DEVICE, all_round_to_clients, label)
    write_logs(log_file,loss_list, accuracy_list, label)
    ...
    loss_list, accuracy_list = run_traditional_fl(fds, initial_net, dataset_name, batch_size, epochs, num_local_epoch, num_clients, DEVICE, all_round_to_clients)
    write_logs(log_file,loss_list, accuracy_list, label)
